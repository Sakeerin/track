      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">
            {t('admin.login.title', 'Admin Console')}
          </h2>
          <p className="mt-2 text-center text-sm text-gray-600">
            {t('admin.login.subtitle', 'Sign in to your account')}
          </p>
        </div>
        ...
        <div className="mt-8 bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          ...
          <div className="space-y-3">
            ...
            >
              ...
              {t('admin.login.googleButton', 'Sign in with Google')}
            </button>
            ...
            >
              ...
              {t('admin.login.microsoftButton', 'Sign in with Microsoft')}
            </button>
          </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-gray-500">
                  {t('admin.login.orDivider', 'Or continue with email')}
                </span>
              </div>
            </div>
          </div>
        ...
        <p className="mt-4 text-center text-sm text-gray-600">
          <a href="/" className="font-medium text-blue-600 hover:text-blue-500">
            {t('admin.login.backToTracking', 'Back to tracking')}
          </a>
        </p>
      </div>
    </div>
